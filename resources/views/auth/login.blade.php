...
<body class="min-h-screen bg-[#F8F9FA] lg:flex">
        ...
        <div class="w-full max-w-[420px] mx-auto my-auto bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
            ...
            <form action="{{ url('/login') }}" method="POST" class="flex flex-col gap-4 sm:gap-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" required autocomplete="current-password" placeholder="Masukkan password" class="w-full px-4 sm:px-5 py-3.5 rounded-full border border-gray-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm placeholder-gray-400 transition-shadow">
                        <button type="button" onclick="togglePassword()" class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors">
    ...
    <script>
        ...
        // Fungsi Toggle Segment Donatur/Pengelola
        ...
        // Set default role pada saat halaman dimuat
